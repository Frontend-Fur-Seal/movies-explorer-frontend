    ...
    <section className="aboutMe" id="student">
      ...
      <div className="aboutMe__info">
        ...
        <p className="aboutMe__text">
          Я родился и живу в Москве, закончил факультет экономики СГУ. У меня
          есть жена и дочь. Я люблю слушать музыку, а ещё увлекаюсь мотокроссом.
      ...
      <a
        href="https://github.com/VladimirSherstnev"
